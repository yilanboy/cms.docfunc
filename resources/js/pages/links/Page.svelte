      ...
      <div class="sm:flex sm:items-center">
        ...
        <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
          <button
            ...
            class="block cursor-pointer rounded-md bg-blue-600 px-3 py-2 text-center text-base font-semibold text-white shadow-xs hover:bg-blue-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 disabled:pointer-events-none disabled:opacity-50"
          >
            Add Link
          </button>
        </div>
              ...
              <tbody class="divide-y divide-gray-200">
                {#each links as link (link.id + link.title + link.url)}
                  <tr>
                    ...
                    <td
                      class="relative flex justify-end gap-2 py-4 pr-4 pl-3 text-base font-medium whitespace-nowrap sm:pr-0"
                    >
                      <button
                        onclick={() =>
